  ...
  return (
    <div className="about-us-page">
      <section className="shop-history">
        ...
        <p>
          Kadhir Jewelry Shop, established in 2002, 
          is a family-owned jewelry business with deep roots in the art of crafting timeless pieces. 
          For generations, we have been known for our exquisite designs, impeccable craftsmanship, and 
          unwavering commitment to quality. Our journey began in Chennai, where tradition and
           innovation met to create a legacy of trust and elegance.
        </p>
        <p>
      ...
      <section className="owner-info">
        ...
        <p>
          Kadhir Jewellery was founded by Mr. Kadhiresh, a visionary who has dedicated his life 
          to the art of jewellery making. With over 21 years of experience in the industry, Mr. Kadhiresh 
          has built a reputation for offering high-quality jewellery that reflects both tradition and luxury. 
          His passion for design and attention to detail has shaped Kadhir Jewellers into one of the leading 
          jewellery stores in Chennai.
        </p>
        <p>
          Our goal is to provide his customers with not just jewellery, but memories that will last 
      ...
      <section className="our-partners">
        ...
        <p>
          At Kadhir Jewellery, we believe in the power of collaboration. Over the years, we have formed 
