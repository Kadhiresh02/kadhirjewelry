  ...
  return (
    <div>
      <section className="homemain">
        <h1>Welcome to Kadhir Jewelers</h1>
      ...
      <section className="Aboutshop">
        ...
        <p className="Aboutshopcont">
          At Kadhir Jewellers, we pride ourselves on offering exquisite gold,  
      ...
      <section className="visit-us">
        ...
        <p className="addresscont">Kadhir Jewellery, Main Road,Dhandeeshwaram,<br></br> near D-mart, Velacherry, Chennai, Tamil Nadu 600007</p>
      </section>
    </div>
  );
};
